...
import type { OracleVerdict, InterventionPayload } from '@bunqsy/shared';
...
const HANDLER_MAP: Partial<Record<string, HandlerFn>> = {
...
export async function dispatchIntervention(
  ...
  if (getActiveIntervention(db)) return null;
